...
async function getAllRecords() {
  ...
  await fetch(`https://api.airtable.com/v0/appJ6cSv5WOCHku6z/Cuisine`, options)
        ...
        newHtml += `
            <div class="col-xxl-4 mb-4"> 
              <div class="card list move border-dark">
                <a href="cuisine.html?id=${data.records[i].id}">
                  ${
                    pictureOfDish
                      ? `<img class="card-img-top rounded" alt="${nameOfDish}" src="${pictureOfDish[0].url}">`
                      : ``
                  }
                </a>
                <div class="card-body">
...
async function getOneRecord(id) {
  ...
  await fetch(
    `https://api.airtable.com/v0/appJ6cSv5WOCHku6z/Cuisine/${id}`,
    options
  )
    .then((response) => response.json())
    .then((data) => {
      ...
      let newHtml = `
        ...
        <div class="row">
          ...
          <div class="col-md-5 d-flex justify-content-end align-content-center">
            <div class="card dish-img mb-0.4">
              ${
                pictureOfDish
                  ? `<img class="card-img-top dish-img rounded" alt="${nameOfDish}" src="${pictureOfDish[0].url}">`
                  : ``
              }
            </div>
          </div>
